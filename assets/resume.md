...
- Implemented evaluation frameworks for RAG systems (RAGAS) to measure retrieval and answer quality.
...
- Led development of an ontology-driven framework mapping business use cases to enterprise data schemas, enabling automated KPI discovery and query generation.
- Developed data pipelines (PySpark, Databricks Jobs) for computer vision outputs.
...
### OMNISCIENCE STRATEGIES, July 2023 - December 2024
